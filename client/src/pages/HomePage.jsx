...
const ROOMS = [
  { id: 'standard', name: 'Standard Room', hindi: 'मानक कक्ष', capacity: 'Up to 2', view: 'Free WiFi',     price: 800,  image: '/images/room_standard.png', desc: 'A clean, peaceful room with all essentials for a comfortable pilgrimage stay near the sacred Sangam.' },
  { id: 'deluxe',   name: 'Deluxe Room',   hindi: 'डीलक्स कक्ष',      capacity: 'Up to 3', view: 'Balcony View', price: 1500, image: '/images/room_deluxe.png',   desc: 'Spacious room with a private balcony overlooking the valley and the cool Himalayan mountain breeze.' },
