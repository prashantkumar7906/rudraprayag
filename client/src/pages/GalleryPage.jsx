...
const IMGS = [
  ...
  { src:'/images/gallery_mountain_peak.jpg', alt:'Majestic mountain peaks in Rudraprayag' },
  { src:'/images/gallery_valley_river.jpg',  alt:'Winding river path through deep Himalayan valley' },
  { src:'/images/gallery_snow_mountains.jpg',alt:'Snow-capped Himalayan peaks towering above local village' },
  { src:'/images/gallery_sunset_terrace.jpg',alt:'Serene sunset vista from the temple terrace' },
  { src:'/images/gallery_mountain_sunset.jpg',alt:'Beautiful golden hour sunset over distant mountain ranges' },
  { src:'/images/gallery_misty_meadow.jpg',  alt:'Misty morning meadow surrounded by green mountain slopes' },
  { src:'/images/gallery_sun_through_trees.jpg',alt:'Morning sunlight filtering through a silhouette of tree branches' },
  { src:'/images/gallery_divine_cloud.jpg',  alt:'A majestic cloud formation back-lit by divine sun rays over the ridge' },
  { src:'/images/gallery_ashram_courtyard.jpg',alt:'Paved courtyard path of the ashram facing the hills' },
  { src:'/images/gallery_misty_valley.jpg',  alt:'Misty sunrise warming the green valleys of Rudraprayag' },
