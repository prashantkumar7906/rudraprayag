        ...
        <div className="container">
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'2.5rem',alignItems:'start'}} className="about-grid">
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'1.25rem'}}>
              ...
              <Link to="/donate">
                <button className="btn-primary" style={{width:'100%',justifyContent:'center',display:'inline-flex',alignItems:'center',gap:'0.45rem'}}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#fff' }}>
                    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                  </svg>
                  Support our seva / हमारी सेवा का समर्थन करें
                </button>
              </Link>
            </div>
